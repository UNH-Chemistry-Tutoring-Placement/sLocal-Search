...
function Grade(timeslot, studentsInTimeslot){
    ...
    if (studentsInTimeslot.length < data.objective.groupSize.min) grade = grade + (belowMin * (data.objective.groupSize.min - studentsInTimeslot.length));
    if (studentsInTimeslot.length > data.objective.groupSize.max) grade = grade + (aboveMax *  (studentsInTimeslot.length - data.objective.groupSize.max));
